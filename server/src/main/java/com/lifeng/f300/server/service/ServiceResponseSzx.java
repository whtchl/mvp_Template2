 ...
 */
public abstract class ServiceResponseSzx<T> implements Observer<T> {
    ...
    public void onError(Throwable e) {
       ...
       if(e.getCause() instanceof  ServiceExceptionSzx){
           LogUtils.d("wang","instance of ServiceException");
           _onError(((ServiceExceptionSzx) e.getCause()).getInfo());
       }else{
